        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-right order-1 lg:order-2">
            ...
            <p className="text-slate-300 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl">
              הצטרפו לכנס דינמי המביא את חזית המדע והטכנולוגיה אל השטח: מחקרים פורצי דרך, הרצאות בגובה העיניים ואתגר אינטראקטיבי ייחודי שיהפוך את הלמידה לחוויה מעשית ומרתקת.
            </p>
